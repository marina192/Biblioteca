...
<div class="usuarios-page">
    ...
    @elseif ($usuario->hasRole('lector'))

        {{-- ── BLOQUE: LECTOR NO EDITABLE ── --}}
        <div class="table-card lector-notice">
            ...
            <h3 class="lector-title">Usuario protegido</h3>
            <p class="lector-desc">
    ...
    @elseif (!Auth::user()->is_super_admin)
        ...
        {{-- ── BLOQUE: ADMINS NO PUEDEN EDITAR ── --}}
        <div class="table-card superadmin-notice">
            <div class="superadmin-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
            ...
            <h3 class="superadmin-title">Información inaccesible</h3>
            <p class="superadmin-desc">
